...
$this->params['breadcrumbs'][] = ['label' => 'Tasks', 'url' => ['tasks', 'project_id'=>$model->project_id]];
        ...
        ['class' => 'yii\grid\ActionColumn',
            ...
            'buttons'=>[
                ...
                'doers'=>function($url, $model){
                    return Html::a(FAS::icon('users'), ['project_doers', 'task_id'=>$model->task_id],[
