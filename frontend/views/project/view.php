    ...
    <div class="text-left pt-0">
        ...
        <div class="row">
            <div class="col-6 text-center">
                ...
                <?= Html::a('Change image', ['update-image', 'id'=>$model->project_id], ['class' => 'btn btn-warning mt-3 w-75 text-center ']) ?>
                <? endif;?>
            </div>
            <div class="col-6  align-self-center">
                ...
                <div class="text-center row">
                    <?if (Yii::$app->user->can('updateProject', ['project'=>$model])):?>
                        <?= Html::a('Update Project', ['update', 'id' => $model->project_id], ['class' => 'btn btn-primary col-3 m-1']) ?>
                        <?= Html::a('Delete Project', ['delete', 'id' => $model->project_id], [
                        ...
                        <?= Html::a('Add Task', ['task-create', 'project_id'=>$model->project_id], ['class' => 'btn btn-success col-2 m-1']) ?>
                    <?endif;?>
                    <?if (Yii::$app->user->can('Employee')):?>
                        <?= Html::a('See All Tasks', ['tasks', 'project_id'=>$model->project_id], ['class' => 'btn btn-info col-3 m-1']) ?>
                    <? endif;?>
                </div>
            </div>
        </div>
